...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        photoView = (ImageView) mRootView.findViewById(R.id.collapsible_image);
        ...
        if (mCursor != null) {
            ...
            viewTitle = titleView.getText().toString();
            bylineView.setText(Html.fromHtml(
                    DateUtils.getRelativeTimeSpanString(
                            ...
                            + "</font>"));
            viewAuthor = bylineView.getText().toString();
            bodyView.setText(Html.fromHtml(mCursor.getString(ArticleLoader.Query.BODY)));
            viewBody = bodyView.getText().toString();
        ...
        final String finalViewAuthor = viewAuthor;
        final String finalViewBody = viewBody;
